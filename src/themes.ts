...
import { ANCIENT_NEW_EVENTS } from './themes-data/ancient.js'
import { ANIME_NEW_EVENTS } from './themes-data/anime.js'
import { NOVEL_NEW_EVENTS } from './themes-data/novel.js'
import { SCI_FI_NEW_EVENTS } from './themes-data/sci-fi.js'
import { URBAN_NEW_EVENTS } from './themes-data/urban.js'
import { WUXIA_NEW_EVENTS } from './themes-data/wuxia.js'
import { XIANXIA_NEW_EVENTS } from './themes-data/xianxia.js'
...
export const DEFAULT_THEMES: readonly ThemeDef[] = [
  {
    ...
    events: [
      ...
      },
      {
        id: 'comet-taxi',
        title: '彗星出租车',
        description: '你搭上一班往返于小行星带的「彗星出租车」，司机是位话痨的退役宇航员，一路给你讲那些没写进航程手册的往事，末了还硬塞给你一罐他珍藏的星尘汽水。',
      ...
      },
      {
        id: 'vending-station',
        title: '失修售货机',
        description: '空间站角落的自动售货机吞了你的硬币，你照着维护手册拍了几下，它却吐出一罐标注「实验品 7 号」的发光饮料。标签上说：饮后可能出现轻微的时间感错乱。',
        effects: { vitality: 4, agility: -1 },
        exp: 12,
        weight: 1,
      },
      {
        id: 'ai-colleague',
        title: '拟人同事',
        description: '新来的同事是台拟人 AI，她总能在你加班到深夜时「恰好」发来一份整理好的代码审查。只是她的冷笑话冷到让整层楼的服务器都打了个寒颤。',
      ...
      {
        id: 'quantum-supermarket',
        title: '量子超市',
        description: '你走进一家货架每隔几秒就会重新排列的超市，收银员坚持说：「这里的东西，你买了它才存在。」结账时，购物袋里多了一件你从没选过的东西。',
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: 'spirit-market',
        title: '夜市寻宝',
        description: '山脚下的修士夜市灯火通明，摊主们把灵器说得天花乱坠。你逛了一圈，发现只有那个沉默寡言的摊位上，一堆「破铜烂铁」里混着真货。',
      ...
      },
      {
        id: 'rain-pavilion',
        title: '雨中亭',
        description: '避雨时，你与一位撑伞的老妇同坐凉亭。她递给你一颗冰糖，说：「年轻人，心浮则气躁。」糖入口，竟有淡淡灵光顺着喉间化开。',
        effects: { vitality: 3, charisma: 2 },
        exp: 11,
        weight: 1,
      },
      {
        id: 'sword-whisper',
        title: '夜半剑鸣',
        description: '子夜时分，你新得的佩剑忽然自行出鞘三寸，剑身嗡鸣不止，剑尖遥遥指向北方那座灯火通明的城池——那里，正有人渡劫。',
        effects: { agility: 4, intelligence: 3 },
        exp: 15,
        minLevel: 2,
        weight: 1,
      },
      {
        id: 'spirit-vein-fever',
        title: '灵脉暴动',
        description: '地底灵脉忽然暴动，方圆百里的灵气紊乱如沸水。宗门长老说，这是千年一遇的「灵潮」，也是散修们百年难逢的机缘。',
        effects: { vitality: 5, luck: 3 },
        exp: 20,
        minLevel: 4,
        weight: 1,
      },
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: 'mammoth-herd',
        title: '长毛象群',
        description: '迁徙的猛犸象群踏过荒原，一头小象掉队，陷在泥沼里动弹不得。你犹豫片刻还是伸出了手——象群首领隔着水雾，静静地看了你很久。',
      ...
      },
      {
        id: 'star-stone',
        title: '陨石之痕',
        description: '部落祭师指着天边一颗拖着尾巴的流星说：每一颗落下的星星，都是先民许过的愿。今夜那颗，恰好落向你的方向。',
        effects: { luck: 4, vitality: 1 },
        exp: 11,
        weight: 1,
      },
      {
        id: 'hunter-trial',
        title: '猎手试炼',
        description: '部落的成年试炼开始了：独自穿越黑森林，带回一头野兽的爪牙。森林深处，有什么东西正注视着你的每一个动作。',
        effects: { agility: 5, strength: 2 },
        exp: 15,
        minLevel: 2,
        weight: 1,
      },
      {
        id: 'ruin-dream',
        title: '遗迹之梦',
        description: '你在遗迹深处的石床上沉沉睡去，梦见一座天空之城缓缓升起。醒来时，掌心里多了一粒刻着星图的黑色石珠。',
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: 'ramen-stand',
        title: '深夜拉面摊',
        description: '训练到深夜，街角的拉面摊还亮着灯。老板是位退役的前职业选手，他看了你一眼，多给你加了一颗溏心蛋：「吃饱了，才有力气变强。」',
        effects: { vitality: 4, charisma: 1 },
        exp: 11,
        weight: 1,
      },
      {
        id: 'cat-helper',
        title: '猫咪帮手',
        description: '你养的猫忽然叼来一只会说话的怀表，怀表自称是异世界的导航仪，现在正式认你为主。猫咪打了个哈欠，仿佛早就知道会这样。',
        effects: { luck: 5, intelligence: -1 },
        exp: 12,
        weight: 1,
      },
      {
        id: 'club-recruit',
        title: '社团招新',
        description: '冷门社团的社长堵住你，声泪俱下地求你入部。他身后的部室里，整整齐齐堆着三座全国大赛的奖杯——不过仔细看，都是「参与奖」。',
        effects: { charisma: 4, agility: 3 },
        exp: 14,
        minLevel: 2,
        weight: 1,
      },
      {
        id: 'beach-episode',
        title: '泳装回',
        description: '明明不是什么特别的日子，全班却忽然决定去海边。有人说这是「惯例」，有人说这是「传统」，你隐隐觉得，这一集结束前一定会发生点什么。',
        effects: { vitality: 4, charisma: 3 },
        exp: 20,
        minLevel: 4,
        weight: 1,
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: 'footnote',
        title: '页脚注释',
        description: '你翻书时发现有一页的页脚印着一行小字注释：「此处主角不该回头。」你合上书，还是忍不住回了头——什么都没发生，但你总觉得躲过了一劫。',
        effects: { luck: 4, intelligence: 1 },
        exp: 11,
        weight: 1,
      },
      {
        id: 'genre-shift',
        title: '题材切换',
        description: '你所在的故事忽然从都市文切成了悬疑文，连旁白都换了个腔调：「空气中弥漫着危险的气息。」你配合地打了个寒颤，顺便记住了这个伏笔。',
        effects: { agility: 3, intelligence: 2 },
        exp: 12,
        weight: 1,
      },
      {
        id: 'side-character',
        title: '配角访谈',
        description: '一位只在第一章出场过的配角忽然找到你，说他已经在书外等了几百章，就想亲口问一句：他到底重不重要？',
      ...
      },
      {
        id: 'author-note',
        title: '作者的话',
        description: '你翻开书末，发现一行作者留言：「写到这一章，我卡了三个月。谢谢你还在这里。」字迹有些模糊，像是真的哭过。',
        effects: { intelligence: 4, charisma: 4 },
        exp: 20,
        minLevel: 4,
        weight: 1,
      },
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: 'inn-keeper',
        title: '客栈掌柜',
        description: '客栈掌柜一眼看出你身上带着伤，二话不说给你上了坛跌打酒，钱却怎么都不肯收：「江湖人，谁没个难处。」',
        effects: { vitality: 3, charisma: 2 },
        exp: 11,
        weight: 1,
      },
      {
        id: 'snow-footprints',
        title: '雪中足迹',
        description: '雪地里一行轻功留下的足迹若有若无，你顺着走了三里，足迹在一棵老梅树前消失。枝头挂着一枚无主的面具，静静地等着什么人。',
        effects: { agility: 4, luck: 1 },
        exp: 12,
        weight: 1,
      },
      {
        id: 'orphan-sword',
        title: '无名剑客',
        description: '渡口边，一位沉默的剑客请你喝了一碗酒，把一柄缠着旧布的长剑推到你面前：「替我保管。若三年后我还活着，再来取。」',
      ...
      },
      {
        id: 'jianghu-rumor',
        title: '江湖流言',
        description: '一夜之间，关于你的流言传遍半个江湖：有人说你身怀绝世武功，有人说你与魔教有旧。你还没来得及辟谣，已有十几拨人找上门来。',
        effects: { charisma: 5, agility: 2 },
        exp: 20,
        minLevel: 4,
        weight: 1,
      },
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: 'shared-umbrella',
        title: '共享雨伞',
        description: '暴雨来得猝不及防，你在便利店门口犹豫时，一个陌生人把伞塞进你手里：「先借你，改天在楼下还我就行。」他说完淋着雨跑远了。',
        effects: { charisma: 3, luck: 2 },
        exp: 11,
        weight: 1,
      },
      {
        id: 'night-market',
        title: '深夜大排档',
        description: '加班结束，大排档老板记得你的口味，还没等你开口就上了老三样。隔壁桌的人聊着「明天要变天」的传闻，你只当是下酒菜。',
        effects: { vitality: 4, intelligence: 1 },
        exp: 12,
        weight: 1,
      },
      {
        id: 'lost-pet',
        title: '寻猫启事',
        description: '电梯里贴着一张寻猫启事，照片里的猫眼神不屑。你在小区后门撞见它时，它正蹲在快递柜顶晒太阳——像是在等你来找它。',
        effects: { charisma: 4, agility: 2 },
        exp: 14,
        minLevel: 2,
        weight: 1,
      },
      {
        ...
        title: '地下市场',
        description: '朋友神神秘秘地带你钻进一栋老楼的地下室，那里有个只开三小时的「午夜市集」。摊上的东西你大多叫不上名字，但每一件都写着「仅此一件」。',
